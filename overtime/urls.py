...
urlpatterns = [
    ...
    path("report/copy/", views.overtime_report_copy, name="overtime_report_copy"),
    path("report/batch-approval/", views.batch_unified_approval, name="batch_unified_approval"),
    path("report/<int:pk>/personal-approval/", views.personal_approval, name="personal_approval"),
